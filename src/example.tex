...
Vim has a robust plugin ecosystem capable of things like autocompletion and syntax highlighting.
IDEs like Intellij tend to have more features that text editors.
In Intellij these include
\begin{itemize}
