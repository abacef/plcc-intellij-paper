...
Extensions are predefined hooks into the IDE that the it supports building on top of, like file type syntax highlighting and adding a run configuration.
All that is necessary is to implement or extend the class or interface that the SDK exposes for the given extension, and register the new class as the extension that has been overrode by the class.
